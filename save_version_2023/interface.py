...
def init_interface (fenetre):
    ...
    text = Text(fenetre)
    photo = Image.open("/Users/anabinet/Desktop/logo_labri.png")
    photo = photo.resize((150, 50), Image.ANTIALIAS)
    UB = Image.open("/Users/anabinet/Desktop/logo_ub.png")
    UB = UB.resize((150, 50), Image.ANTIALIAS)
    UBM = Image.open("/Users/anabinet/Desktop/logo_ubm.png")
